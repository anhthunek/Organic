...
if (isset($_POST['add_category_btn'])) {
    ...
    if ($new_image != "") {
        ...
        $image_ext = pathinfo($image, PATHINFO_EXTENSION);
        $upload_filename = time() . '.' . $image_ext;
    } else {
    ...
    if ($name != "" && $slug != "" && $description != "") {
        $product_query = "INSERT INTO products (category_id, name , slug, small_description, big_description ,original_price,selling_price,qty,meta_title, meta_description, meta_keywords, status, trending, image) 
...
else if (isset($_POST['update_order-btn'])) {
