...
?>
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " style="background-color: #76A713; " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0 text-center" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        <img src="https://demo.casethemes.net/organio/wp-content/themes/orgio/assets/images/logo-mobile.png" width="100px" alt="">
      </a>
    </div>
