...
if (isset($_SESSION['auth'])) {
    if (isset($_POST['placeOrderBtn'])) {   
        ...
        $tracking_no = "organico" . rand(1111, 999) . substr($phone, 2);
        // $user_id = $_SESSION['auth_user']['user_id'];
        $insert_query = "INSERT INTO orders (tracking_no,	user_id,	name,	email,	phone,	address,	pincode,	total_price	,payment_mode,	payment_id	) VALUES ('$tracking_no','$userId','$name', '$email', '$phone','$address', '$pincode', '$totalPrice', '$payment_method', '$payment_id' )";
